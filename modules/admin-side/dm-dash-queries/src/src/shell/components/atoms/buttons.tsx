export interface ButtonProps {
    ...
    shape?: "default" | "circle" | "square" | "pill" | "rectangle";
    className?: string;
...
export const Button = ({ children, onClick, props, shape = "default", className, theme = "default" }: ButtonProps) => {
    ...
    const buttonThemes = {
        ...
        simple_border: "rounded-none text-slate-700 hover:bg-slate-300 hover:text-primary border-b-2 border-slate-300 px-2 pt-2 pb-1",
