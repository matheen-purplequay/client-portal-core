...
import Jobs, { type JobQuery } from "./job-queries/jobs";
        ...
        <div>
            <div>
                ...
                {!isLoading && jobQueries && jobQueries.length > 0 && !selectedJobQuery &&
                    <Jobs jobQueries={jobQueries} onRefresh={fetchJobQueries} isRefreshing={isLoading} autoOpenJobId={context?.jobId} />
                }
