...
@Component({
  selector: 'pq-simple-horizontal-loading',
  templateUrl: './simple-horizontal-loading.component.html',
  styleUrls: ['./simple-horizontal-loading.component.scss']
})
export class SimpleHorizontalLoadingComponent implements OnInit {
